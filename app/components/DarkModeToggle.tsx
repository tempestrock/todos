...
/**
 * The toggle to switch between light and dark mode.
 */
  ...
  return (
    <div className="flex items-center">
      <button
        ...
        className="relative inline-flex items-center h-6 rounded-full w-11 mt-1 mb-1 ml-2 border border-blue-500 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 bg-gray-100 dark:bg-indigo-600"
      >
        ...
        />
        <div className="ml-14 text-gray-900 dark:text-gray-100">Mode</div>
      </button>
    </div>
  )
}
